...
import { Button, Empty, Skeleton, Pagination, message } from "antd";
...
const Bailling = () => {
  ...
  return (
    <div className="p-4">
      {contextHolder}
      <h1 className="font-bold text-2xl">Balling Fund</h1>
      ...
      <div className="flex justify-center items-center gap-10 my-15">
        <Link
          to="/top-up-account"
          state={{ accountName: "Balling Fund Account", wallet }}
      ...
      {/* Info Section */}
      <div className="bg-[#f7c1757a] rounded-2xl w-2/3 mx-auto p-9">
        <div className="flex justify-between items-center">
          <p className="font-bold mb-3">What is Balling Goal?</p>
          <img src={cancel} alt="" className="w-5 -mt-3" />
        </div>
        <p className="text-[#8A8A8A]">
          Contrary to popular belief, Lorem Ipsum is not simply random text. It
          has roots in a piece of classical Latin literature from ancient times.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="w-full lg:overflow-x-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:min-w-[900px] pb-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-[#f7c1757a] rounded-lg p-5">
                ...
                <p className="text-2xl mt-3">
                  ...
                  <span className="text-[#0047FF]">Balling Goal</span>
                </p>
              </div>
            ))}
          </div>
